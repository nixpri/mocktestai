...
import { ArrowLeft, Save, Plus, X, AlertCircle, Loader2 } from 'lucide-react'
      ...
      if (data.success) {
        ...
        if (question) {
          setFormData({
            ...
            numericalTolerance: question.numericalTolerance || 0.01,
            assertion: question.assertion || '',
            reason: question.reason || '',
            assertionReasonAnswer: question.correctAnswer || 'A',
